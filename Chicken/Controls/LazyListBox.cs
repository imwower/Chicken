...
namespace Chicken.Controls
{
    ...
    public class LazyListBox : ListBox
    {
        ...
        const string VerticalCompressionVisualStateGroupName = "VerticalCompression";

        const string VerticalCompressionTopVisualStateName = "CompressionTop";

        const string VerticalCompressionBottomVisualStateName = "CompressionBottom";

        const string NoVerticalCompressionVisualStateName = "NoVerticalCompression";
        ...
        VisualStateGroup verticalCompressionVisualStateGroup = null;
        ...
        void UnhookScrollingEvents()
        {
            ...
            if (verticalCompressionVisualStateGroup != null)
                verticalCompressionVisualStateGroup.CurrentStateChanged -= vgroup_CurrentStateChanging;
        }
        ...
        void vgroup_CurrentStateChanging(object sender, VisualStateChangedEventArgs e)
        {
            ...
            if (e.NewState.Name == NoVerticalCompressionVisualStateName)
            {
